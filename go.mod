...
replace (
	github.com/cosmos/cosmos-sdk => github.com/d-foundation/cosmos-sdk v0.53.4-dchain
	// github.com/d-foundation/protocol => github.com/d-foundation/private-protocol v0.7.0
	github.com/forbole/juno/v6 => github.com/d-foundation/juno/v6 v6.1.1-dchain
